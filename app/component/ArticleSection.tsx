...
export default function ArticleSection() {
  return (
    <section
      id="review"
      className="py-16 flex justify-center items-center bg-dark"
    >
      <div className="grid grid-cols-1 md:grid-cols-3 gap-9 max-w-8xl w-full px-10">
        {articles.map((a, i) => (
          <div
            key={i}
            className="bg-[#0f1926] rounded-xl overflow-hidden shadow-lg transition-transform duration-300 hover:scale-105 w-full aspect-square flex flex-col"
          >
            <Image
              src={a.img}
              alt={a.title}
