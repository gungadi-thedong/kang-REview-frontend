...
export default function Navbar() {
  return (
    <nav className=" absolute w-full flex justify-between items-center px-50 pt-7 pb-5 bg-[#0b1623] text-white">
      {/* Logo */}
      <div>
        <Image src="/Kang Riview.png" alt="logo" width={80} height={40} />
      </div>
      ...
      <div className=" w-full justify-center flex gap-15 font-bold text-base">
        ...
        <Link href="/article" className="hover:text-gray-500">
          Review
        </Link>
